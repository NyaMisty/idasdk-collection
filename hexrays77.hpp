...
#define OPROP_LOWADDR 0x20 ///< a low address offset
  ...
  HEXRAYS_MEMORY_ALLOCATION_FUNCS()
  void zero(void) { t = mop_z; oprops = 0; valnum = 0; size = NOSIZE; nnn = nullptr; }
...
struct mba_ranges_t
{
  func_t *pfn = nullptr; ///< function to decompile
...
struct mba_item_iterator_t
{
  ...
  func_item_iterator_t fii;     // this is used if rii.ranges==nullptr
  bool is_snippet(void) const { return rii.ranges != nullptr; }
...
#define MBA2_ALL_FLAGS    0x00001FFF
...
//@}
  ...
  cexpr_t(ctype_t cop, cexpr_t *_x) : citem_t(cop), x(_x), y(nullptr), z(nullptr), exflags(0) {}
  cexpr_t(ctype_t cop, cexpr_t *_x, cexpr_t *_y) : citem_t(cop), x(_x), y(_y), z(nullptr), exflags(0) {}
