...
#define MBA2_DONT_VERIFY   0x80000000 // Do not verify microcode. This flag is
                                      // dangerous and is recomended to set
                                      // only when debugging decompiler plugins
...
//@}
  ...
  /// \param callargs The helper arguments (NULL-no arguments)
  /// \param out      The operand where the call result should be stored.
  ///                 If this argument is not NULL, "mov helper_call(), out"
...
public:
  ...
  //                  (NULL if no instruction was generated)
  /// \return success
...
enum hexrays_event_t ENUM_SIZE(int)
{
  ...
  hxe_build_callinfo,   ///< Analyzing a call instruction.
                        ...
                        ///< Should return: 1 if the function type has been determined.
